function showGraphWithHighLightedStates(transitionMatrix, listOfOrangeStates, listOfRedStates)
...
% Highlighting specific states with different colors
highlight(h, listOfRedStates, 'NodeColor', 'red');    % Change color for states 1 and 3
highlight(h, listOfOrangeStates, 'NodeColor', 'yellow');    % Change color for state 2
